...
import { Copy, Eye, EyeOff, AlertTriangle, Loader2, CheckCircle, Wallet, Coins } from 'lucide-react'
      ...
      {walletAddress && (
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-xs text-muted-foreground uppercase tracking-wide font-medium">Total Spent on Plans</p>
          </div>
